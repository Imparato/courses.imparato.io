...
puts "creating coursanantes as a site"

coursanantes = Site.new(
  domain_name:      "coursdetheatrenantes.com",
  name:             "Cours de théâtre à nantes",
  meta_title:       "Trouvez les meilleurs cours à nantes",
...
tetard = Company.create!(
  ...
  address:     "33 Rue Ferrari, 13005 nantes",
  mail:        "mail@gmail.com",
...
roche = Company.create!(
  ...
  address:     "19, quai de Rive Neuve, 13007 nantes",
  mail:        "mail@gmail.com",
  phone:       "04 09 87 98 98",
  website:     "www.sitedutheatre.com",
...
merlan = Company.create!(
  ...
  address:     "39 Avenue du Merlan, 13014 nantes",
  mail:        "mail@gmail.com",
  phone:       "04 09 87 98 98",
  website:     "www.sitedutheatre.com",
...
divadlo = Company.create!(
  ...
  address:     "69, rue sainte cécile, 13005 nantes",
  mail:        "mail@gmail.com",
  phone:       "04 09 87 98 98",
  website:     "www.sitedutheatre.com",
...
orchestra = Company.create!(
  ...
  address:     "17, rue Pierre Dupré, 13008 nantes",
  mail:        "mail@gmail.com",
  phone:       "04 09 87 98 98",
  website:     "www.sitedutheatre.com",
...
cours = Company.create!(
  ...
  address:     "2 Boulevard Cauvin, 13009 nantes",
  mail:        "mail@gmail.com",
  phone:       "04 09 87 98 98",
  website:     "www.sitedutheatre.com",
...
nantesimpro = CrossPage.new(
  slug:             "impro-a-nantes",
  title:            "Cours d'improvisation à nantes",
  description:      "Trouvez les meilleurs cours d'improvisation sur nantes facilement",
  active:           "true",
  meta_title:       "nantes PACA Bouche du Rhone 13",
  meta_description: "Les meilleurs cours du sud sont sur coursanantes",
  site:             coursanantes,
)
nantesimpro.remote_banner_url = url
nantesimpro.save!

nantestheatre = CrossPage.new(
  slug:             "theatre-a-nantes",
  title:            "Cours de théâtre à nantes",
  description:      "Trouvez les meilleurs cours d'improvisation sur nantes facilement",
  active:           "true",
  meta_title:       "nantes PACA Bouche du Rhone 13",
  meta_description: "Les meilleurs cours du sud sont sur coursanantes",
...
nantestheatre.remote_banner_url = url
nantestheatre.save!

nanteslundi = CrossPage.new(
  slug:             "lundi-a-nantes",
  title:            "Cours sur nantes le lundi",
  description:      "Trouvez les meilleurs cours le lundi sur nantes facilement",
  active:           "true",
  meta_title:       "nantes PACA Bouche du Rhone 13",
  meta_description: "Les meilleurs cours du sud sont sur coursanantes",
  site:             coursanantes,
)
nanteslundi.remote_banner_url = url
nanteslundi.save!

nantesmardi = CrossPage.new(
  slug:             "mardi-a-nantes",
  title:            "Cours sur nantes le mardi",
  description:      "Trouvez les meilleurs cours le mardi sur nantes facilement",
  active:           "true",
  meta_title:       "nantes PACA Bouche du Rhone 13",
  meta_description: "Les meilleurs cours du sud sont sur coursanantes",
  site:             coursanantes,
)
nantesmardi.remote_banner_url = url
nantesmardi.save!

nantesmercredi = CrossPage.new(
  slug:             "mercredi-a-nantes",
  title:            "Cours sur nantes le mercredi",
  description:      "Trouvez les meilleurs cours le mercredi sur nantes facilement",
  active:           "true",
  meta_title:       "nantes PACA Bouche du Rhone 13",
  meta_description: "Les meilleurs cours du sud sont sur coursanantes",
  site:             coursanantes,
)
nantesmercredi.remote_banner_url = url
nantesmercredi.save!

nantesjeudi = CrossPage.new(
  slug:             "jeudi-a-nantes",
  title:            "Cours sur nantes le jeudi",
  description:      "Trouvez les meilleurs cours le jeudi sur nantes facilement",
  active:           "true",
  meta_title:       "nantes PACA Bouche du Rhone 13",
  meta_description: "Les meilleurs cours du sud sont sur coursanantes",
  site:             coursanantes,
)
nantesjeudi.remote_banner_url = url
nantesjeudi.save!

nantesvendredi = CrossPage.new(
  slug:             "vendredi-a-nantes",
  title:            "Cours sur nantes le vendredi",
  description:      "Trouvez les meilleurs cours le vendredi sur nantes facilement",
  banner:           File.new(File.join(Rails.root, "/app/assets/images/photo_nantes.jpeg")),
  active:           "true",
  meta_title:       "nantes PACA Bouche du Rhone 13",
  meta_description: "Les meilleurs cours du sud sont sur coursanantes",
  site:             coursanantes,
)
nantesvendredi.remote_banner_url = url
nantesvendredi.save!

nantesweekend = CrossPage.new(
  slug:             "weekend-a-nantes",
  title:            "Cours sur nantes le weekend",
  description:      "Trouvez les meilleurs cours le weekend sur nantes facilement",
  active:           "true",
  meta_title:       "nantes PACA Bouche du Rhone 13",
  meta_description: "Les meilleurs cours du sud sont sur coursanantes",
  site:             coursanantes,
)
nantesweekend.remote_banner_url = url
nantesweekend.save!
...
cours.tags << vendredi
cours.tags << impro
nantesimpro.tags << impro
nanteslundi.tags << lundi
nantestheatre.tags << theatre
nantesmardi.tags << mardi
nantesmercredi.tags << mercredi
nantesjeudi.tags << jeudi
nantesvendredi.tags << vendredi
nantesweekend.tags << week_end
