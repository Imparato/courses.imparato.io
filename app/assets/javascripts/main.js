        ...
        $(window).on('load resize', function () {
            ...
            if (currMenuType !== menuType) {
                ...
                if (currMenuType === 'mobile') {
                    ...
                    $('#mainnav-mobi').children('.menu').append('<li class="button"><a class="flat-button" href="add-listing.html">Add Listing</a></li>');
                } else {
                ...
                map: {
                    options: {
                        ...
                        mapTypeControlOptions: {
                            mapTypeIds: ['List Land', google.maps.MapTypeId.SATELLITE, google.maps.MapTypeId.HYBRID]
                        },
                        scrollwheel: false
                    }
                },
